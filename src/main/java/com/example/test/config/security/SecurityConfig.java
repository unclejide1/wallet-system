...
public class SecurityConfig {
    ...
    private final CustomAccessDeniedHandler accessDeniedHandler; // Inject here
    private final CustomAuthenticationEntryPoint authenticationEntryPoint; // Inject here
